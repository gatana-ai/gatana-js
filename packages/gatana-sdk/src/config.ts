...
export function readConfig(): GatanaFileConfig {
  try {
...
export function writeConfig(config: GatanaFileConfig): void {
  try {
...
export function updateConfig(updates: Partial<GatanaFileConfig>): void {
